...
describe('测试 mockFloat 函数', () => {
    ...
    test('当传入参数时，返回指定范围内的浮点数，小数点后保留指定位数', () => {
...
describe('测试 mockNatural 函数', () => {
    ...
    test('当传入的 min 或 max 小于 0 时，抛出错误', () => {
